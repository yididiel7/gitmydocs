...
You can keep them installed, but they must not be active at the same
time as NetworkManager.
...
NetworkManager includes a powerful command-line tool called nmcli.
Let’s go through some common tasks using it.
...
You can navigate using arrow keys and configure Wi-Fi, Ethernet,
or VPN connections without needing to remember commands.
...
profile.
You can manage these profiles with nmcli.
...
"MySSID" -- wifi-sec.key-mgmt wpa-psk
